...
//        InputStream input= CsvUtils.class.getClass().getClassLoader().getResourceAsStream(path );
        InputStream input =  CsvUtils.class.getClassLoader().getResourceAsStream(path);
